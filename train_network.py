"""Train network from MNIST format database."""
#!/usr/env/python3
# -*- coding: UTF-8 -*
...
def main(_):
    # Import data
    mnist = input_data.read_data_sets(flags.database_folder, one_hot=True)
    ...
    with tf.Session() as sess:
        ...
        # NPS change 20000 to smaller number if you are testing
        # for i in range(1000):
...
if __name__ == '__main__':
    set_logger('{}/log_train_network_{}.txt'.format(LOG_PATH, get_current_time()))
